...
**Внимание! Данный репозиторий больше не поддерживается. Если вы хотите использовать более свежую версию проекта, пожалуйста, переходите на [Hello Neighbor Kit](https://gitlab.com/Xrisofor/helloneighborkit).**
